...
namespace Atnic\SBAdmin2\Console\Commands;

use Illuminate\Console\Command;

class SBAdmin2MakeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:sb-admin-2 {--views : Only scaffold the views}';
     ...
     * @var string
     */
    protected $description = 'Scaffold basic make:auth with SB Admin 2 Template';
    ...
    public function handle()
    {
        ...
        $this->info('Start SB Admin 2 scaffolding');
